...
META_PATH = "meta.pkl"
#You can use this directory for saving the checkpoints
EXPERIMENT_CKPT_DIR = "data/checkers_games/experiments"
# -----------------------------------------------------------------------------
...
wandb_run_name = '8layer_human' #'gpt2' # 
...
#If you want to resume logging
# if wandb_log and master_process:
#     import wandb
#     wandb.init(project=wandb_project, id="put_your_id_here", resume="must", config=config)
