...
SAMPLE_DUMP_NAME = "data/checkers_games/sample_dump/"         #For checking the valid moves
...
# Pickle the list
os.makedirs(SAMPLE_DUMP_NAME, exist_ok=True)
with open(SAMPLE_DUMP_NAME+'sample_dump.pkl', 'wb') as f:
